  ...
  return (
    <div className="flex flex-col gap-1" data-testid="workflow-run-settings-model">
      ...
      {noCatalog ? (
        ...
        <div className="min-w-0" data-model-current-value={value}>
          <ModelConfigSelect
            modelGroups={groups}
      ...
      {inheritedLabel ? (
        <p
          ...
          data-testid="workflow-run-inherited-options"
        >
          {inheritedLabel}
        </p>
      ) : null}
      <div className="grid grid-cols-2 gap-2 pt-1">
        {thoughtOption === null ? null : (
          <div className="flex min-w-0 flex-col gap-1">
            <FieldLabel>
              {intl.formatMessage({ id: "chat.toolbar.thoughtLevel.tooltip" })}
            </FieldLabel>
        ...
        {speeds.length === 0 ? null : (
          <div className="flex min-w-0 flex-col gap-1">
            <FieldLabel>{intl.formatMessage({ id: "chat.toolbar.speed.tooltip" })}</FieldLabel>
            <ModelSpeedControl
              values={speeds}
              value={speed}
              disabled={disabled}
