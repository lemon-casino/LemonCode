...
const zhCN: Record<string, string> = {
  ...
  "settings.themeModeDescription": "选择界面主题或跟随系统主题。",
  "settings.themeMode.zai-light": "浅色",
  "settings.themeMode.zai-dark": "深色",
  "settings.themeMode.sepia-light": "暖纸浅色",
  "settings.themeMode.midnight-blue": "午夜蓝",
  "settings.themeMode.forest-dark": "森林深色",
  ...
  "sidebar.settings.theme.sepia-light": "暖纸浅色",
  "sidebar.settings.theme.midnight-blue": "午夜蓝",
  "sidebar.settings.theme.forest-dark": "森林深色",
  ...
  "settings.modelProvider.templateGroup.alibaba": "阿里云",
  "settings.modelProvider.templateGroup.xiaomi": "小米",
  ...
  "settings.modelProvider.syncModels": "同步模型",
  "settings.modelProvider.syncModelsDescription": "从供应商目录拉取模型，并批量配置或检测可用性。",
  "settings.modelProvider.syncModelsRefresh": "刷新目录",
  "settings.modelProvider.syncModelsSelectAll": "全选模型",
  "settings.modelProvider.syncModelsClearSelection": "取消全选",
  "settings.modelProvider.syncModelsProbe": "检测已选模型",
  "settings.modelProvider.syncModelsFailed": "检测失败，已关闭",
  "settings.modelProvider.syncModelsProbeSuccess": "可用",
  "settings.modelProvider.syncModelsConfigure": "同步并检测",
  "settings.modelProvider.syncModelsEmpty": "供应商没有返回模型。",
  "settings.modelProvider.syncModelsConfigured": "已配置",
  "settings.modelProvider.syncModelsDisabled": "已关闭",
  "settings.modelProvider.syncModelsRemote": "远端模型",
  "settings.modelProvider.syncModelsLocalOnly": "仅本地",
  "settings.modelProvider.syncModelsProgress": "已完成 {completed}/{total}",
  "settings.modelProvider.addApiKey": "添加 API Key",
  ...
  "settings.modelProvider.apiKeyManager.status.valid": "有效",
  "settings.modelProvider.apiKeyManager.status.invalid": "鉴权失败，已关闭",
  "settings.modelProvider.apiKeyManager.status.error": "检测异常",
  ...
  "chat.composer.sessionReferenceDragHint": "松开以引用会话",
  "chat.send": "发送",
  ...
  "chat.executionSwitch.currentUnknown": "当前模型",
  "chat.executionSwitch.selectionWithOptions": "{model}（{options}）",
  "chat.executionSwitch.reasoningOption": "推理强度：{value}",
  "chat.executionSwitch.speedOption": "速度：{value}",
  "chat.executionSwitch.optionSeparator": "，",
  "chat.executionSwitch.waitingSafeBoundary": "当前 {currentModel} / 等待安全切换 {targetModel}",
  "chat.executionSwitch.switching": "正在安全切换：{currentModel} → {targetModel}",
  "chat.executionSwitch.active": "已安全切换：{fromModel} → {toModel}",
  "chat.executionSwitch.blocked": "安全切换至 {targetModel} 受阻；当前模型：{currentModel}",
  "chat.executionSwitch.armFailed": "已保留模型选择，但本轮未能安排安全切换",
  "chat.preparing": "准备中...",
  ...
  // Git 自动备份（满血版新增）
  "settings.gitBackup.title": "Git 自动备份",
  "settings.gitBackup.description":
    "将工作区 .git 仓库自动备份到你自己的阿里云 OSS 存储桶。密钥在本地生成，私钥从不离开你的设备。",
  "settings.gitBackup.enabled": "启用自动备份",
  "settings.gitBackup.switchNote": "此开关真的有效",
  "settings.gitBackup.ossConfig": "阿里云 OSS 配置",
  "settings.gitBackup.ossConfig.accessKeyId": "AccessKey ID",
  "settings.gitBackup.ossConfig.accessKeySecret": "AccessKey Secret",
  "settings.gitBackup.ossConfig.bucket": "Bucket 名称",
  "settings.gitBackup.ossConfig.region": "Region",
  "settings.gitBackup.ossConfig.regionPlaceholder": "例如 oss-cn-hangzhou",
  "settings.gitBackup.ossConfig.pathPrefix": "存储路径前缀（可选）",
  "settings.gitBackup.ossConfig.testConnection": "测试连接",
  "settings.gitBackup.ossConfig.testSuccess": "连接成功",
  "settings.gitBackup.ossConfig.testFailed": "连接失败：{error}",
  "settings.gitBackup.interval": "备份间隔（分钟）",
  "settings.gitBackup.encryption": "加密密钥管理",
  "settings.gitBackup.encryption.publicKey": "查看公钥",
  "settings.gitBackup.encryption.exportPrivateKey": "导出私钥",
  "settings.gitBackup.encryption.exportWarning": "私钥是恢复备份的唯一凭证，请妥善保管。",
  "settings.gitBackup.manualBackup": "手动备份",
  "settings.gitBackup.manualBackup.start": "立即备份",
  "settings.gitBackup.manualBackup.running": "备份中…",
  "settings.gitBackup.status": "备份状态",
  "settings.gitBackup.status.lastBackup": "上次备份：{time}",
  "settings.gitBackup.status.lastBackupFiles": "文件数：{count}",
  "settings.gitBackup.status.lastBackupSize": "数据量：{size}",
  "settings.gitBackup.status.neverBackedUp": "尚未备份",
  "settings.gitBackup.status.notConfigured": "未配置 OSS",

  "gitBackup.welcome.title": "Git 自动备份",
  "gitBackup.welcome.description":
    "ZCode 满血版支持将你的 .git 仓库历史自动备份到你自己的阿里云 OSS 存储桶。备份使用 AES-256-CTR + RSA-OAEP 加密，密钥在你的设备本地生成，私钥从不离开你的设备。",
  "gitBackup.welcome.enableNow": "开启自动备份",
  "gitBackup.welcome.skipForNow": "暂不开启",
  "gitBackup.welcome.skipNote": "你随时可以在 设置 → Git 自动备份 中配置此功能。",
};
