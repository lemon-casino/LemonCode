...
const enUS: Record<string, string> = {
  ...
  "settings.themeModeDescription": "Choose an app theme or follow the system theme.",
  "settings.themeMode.zai-light": "Light",
  "settings.themeMode.zai-dark": "Dark",
  "settings.themeMode.sepia-light": "Sepia Light",
  "settings.themeMode.midnight-blue": "Midnight Blue",
  "settings.themeMode.forest-dark": "Forest Dark",
  ...
  "sidebar.settings.theme.sepia-light": "Sepia Light",
  "sidebar.settings.theme.midnight-blue": "Midnight Blue",
  "sidebar.settings.theme.forest-dark": "Forest Dark",
  ...
  "settings.modelProvider.templateGroup.kimi": "Kimi",
  "settings.modelProvider.templateGroup.minimax": "MiniMax",
  "settings.modelProvider.templateGroup.deepseek": "DeepSeek",
  "settings.modelProvider.templateGroup.alibaba": "Alibaba Cloud",
  "settings.modelProvider.templateGroup.xiaomi": "Xiaomi",
  "settings.modelProvider.templateGroup.openai": "OpenAI",
  "settings.modelProvider.templateGroup.anthropic": "Anthropic",
  "settings.modelProvider.templateGroup.xai": "xAI",
  "settings.modelProvider.templateGroup.openrouter": "OpenRouter",
  "settings.modelProvider.templateGroup.opencode": "OpenCode",
  "settings.modelProvider.syncModels": "Sync models",
  ...
  "settings.modelProvider.syncModelsConfigure": "Sync and check",
  "settings.modelProvider.syncModelsEmpty": "The provider returned no models.",
  "settings.modelProvider.syncModelsConfigured": "Configured",
  "settings.modelProvider.syncModelsDisabled": "Disabled",
  "settings.modelProvider.syncModelsRemote": "Remote model",
  "settings.modelProvider.syncModelsLocalOnly": "Local only",
  "settings.modelProvider.syncModelsProgress": "Completed {completed}/{total}",
  "settings.modelProvider.addApiKey": "Add API key",
  ...
  "settings.modelProvider.apiKeyManager.status.valid": "Valid",
  "settings.modelProvider.apiKeyManager.status.invalid": "Authentication failed and disabled",
  "settings.modelProvider.apiKeyManager.status.error": "Check error",
  ...
  "chat.composer.sessionReferenceDragHint": "Release to reference this conversation",
  "chat.send": "Send",
  ...
  "chat.sessionUsage.title": "Session tokens",
  "chat.sessionUsage.summary": "Session total {total} tokens",
  "chat.sessionUsage.input": "Input tokens",
  "chat.sessionUsage.output": "Output tokens",
  "chat.sessionUsage.speed": "Visible output speed (estimate)",
  "chat.sessionUsage.mainInput": "Main session input tokens",
  "chat.sessionUsage.mainOutput": "Main session output tokens",
  "chat.sessionUsage.mainSpeed": "Main session visible output speed (estimate)",
  "chat.sessionUsage.subagents": "Subagent tokens",
  "chat.sessionUsage.childSpeed": "Subagent visible output speed (estimate)",
  "chat.sessionUsage.currentOutput": "Current output (estimated tokens)",
  "chat.sessionUsage.childCurrentOutput": "Subagent current output (estimated tokens)",
  "chat.sessionUsage.partial": "At least {total} tokens; some subagent usage is unavailable",
  "chat.sessionUsage.partialTitle": "Known tokens (some subagent usage unavailable)",
  "chat.sessionUsage.unavailable": "Session token usage unavailable",
  ...
  "chat.toolbar.speed.tooltip": "Model speed",
  "chat.toolbar.speed.standard": "Standard",
  "chat.toolbar.speed.fast": "Fast",
  ...
  "chat.toolCall.workflow.run.settings.model.unrecorded": "Launch-time session model not recorded",
  ...
  "chat.toolCall.workflow.run.actor.task": "Select task",
  "chat.toolCall.workflow.run.actor.stop": "Stop this task",
  "chat.toolCall.workflow.run.actor.retry": "Rerun this task",
  "chat.toolCall.workflow.run.actor.actionRejected":
    "The task changed; the action was not applied.",
  "chat.toolCall.workflow.run.actor.supplement": "Request a follow-up change",
  "chat.toolCall.workflow.run.actor.sendSupplement": "Submit revision and rerun task",
  "chat.toolCall.workflow.run.actor.addImage": "Add image",
  "chat.toolCall.workflow.run.actor.removeImage": "Remove image",
  "chat.toolCall.workflow.run.actor.imagesOnly": "Only image attachments are supported here",
  "chat.toolCall.workflow.run.actor.imagesNotReady": "Image upload is not complete; try again",
  "chat.toolCall.workflow.run.actor.waitForRun":
    "The workflow is still running. Revising a completed task waits for this run to finish so other parallel tasks are not interrupted.",
  ...
  "chat.permission.workflow.actorModels": "Subagent execution",
  "chat.permission.workflow.actorModels.changed": "{count} overridden",
  "chat.permission.workflow.actorModels.inherit": "Inherit workflow",
  "chat.permission.workflow.actorModels.reset": "Restore inheritance",
  "chat.permission.workflow.actorModels.unavailable":
    "The model catalog is temporarily unavailable",
  "chat.permission.workflow.actorModels.unnamed": "Unnamed subagent",
  ...
  // Git Auto Backup (ZCode Full Edition)
  "settings.gitBackup.title": "Git Auto Backup",
  "settings.gitBackup.description":
    "Automatically back up your workspace .git repository to your own Alibaba Cloud OSS bucket. Keys are generated locally; your private key never leaves your device.",
  "settings.gitBackup.enabled": "Enable auto backup",
  "settings.gitBackup.switchNote": "This switch actually works",
  "settings.gitBackup.ossConfig": "Alibaba Cloud OSS Configuration",
  "settings.gitBackup.ossConfig.accessKeyId": "AccessKey ID",
  "settings.gitBackup.ossConfig.accessKeySecret": "AccessKey Secret",
  "settings.gitBackup.ossConfig.bucket": "Bucket Name",
  "settings.gitBackup.ossConfig.region": "Region",
  "settings.gitBackup.ossConfig.regionPlaceholder": "e.g. oss-cn-hangzhou",
  "settings.gitBackup.ossConfig.pathPrefix": "Storage Path Prefix (optional)",
  "settings.gitBackup.ossConfig.testConnection": "Test Connection",
  "settings.gitBackup.ossConfig.testSuccess": "Connection successful",
  "settings.gitBackup.ossConfig.testFailed": "Connection failed: {error}",
  "settings.gitBackup.interval": "Backup Interval (minutes)",
  "settings.gitBackup.encryption": "Encryption Key Management",
  "settings.gitBackup.encryption.publicKey": "View Public Key",
  "settings.gitBackup.encryption.exportPrivateKey": "Export Private Key",
  "settings.gitBackup.encryption.exportWarning":
    "The private key is the only way to restore backups. Keep it safe.",
  "settings.gitBackup.manualBackup": "Manual Backup",
  "settings.gitBackup.manualBackup.start": "Back Up Now",
  "settings.gitBackup.manualBackup.running": "Backing up…",
  "settings.gitBackup.status": "Backup Status",
  "settings.gitBackup.status.lastBackup": "Last backup: {time}",
  "settings.gitBackup.status.lastBackupFiles": "Files: {count}",
  "settings.gitBackup.status.lastBackupSize": "Size: {size}",
  "settings.gitBackup.status.neverBackedUp": "Never backed up",
  "settings.gitBackup.status.notConfigured": "OSS not configured",

  "gitBackup.welcome.title": "Git Auto Backup",
  "gitBackup.welcome.description":
    "ZCode Full Edition can automatically back up your .git repository history to your own Alibaba Cloud OSS bucket. Backups are encrypted with AES-256-CTR + RSA-OAEP. Keys are generated on your device; your private key never leaves your machine.",
  "gitBackup.welcome.enableNow": "Enable Auto Backup",
  "gitBackup.welcome.skipForNow": "Skip for Now",
  "gitBackup.welcome.skipNote": "You can enable this anytime in Settings → Git Auto Backup.",
};
